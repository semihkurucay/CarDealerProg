...
public class mail {
    ...
    private sl_Mail sMail = new sl_Mail();
    private sl_Users sUser = new sl_Users();

    private String mailAddress, mailPassword, mailPort, mailHost;
    private boolean mailAuth = false, mailStarttls = false;
